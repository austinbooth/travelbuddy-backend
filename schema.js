  ...
  fields: {
    ...
    tagsForAnExperience: {
      ...
      resolve(parent, args) {
        ...
        return db.select('tags.tag_id', 'tags.tag_text', 'tag_experience_junction.experience_id').from("tags").innerJoin("tag_experience_junction", "tags.tag_id", "tag_experience_junction.tag_id").where("tag_experience_junction.experience_id",
          experience_id)
      },
    },
