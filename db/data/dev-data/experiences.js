module.exports = [{
...

  {
    ...
    body: 'We found a really cute craft market to the left of the main market square. Great gifts and the sellers were really interesting talking about their work. Some of them let our kids have a go - they loved it!',
    username: 'tillRitzy',
  ...
  },
  {
    ...
    body: 'Came across this gem when my daughter had to nip in and use the loo! The kids loved dancing at a grown up disco with the lights and atmosphere, but dancing to their music. We had a great boogie too, never too old to let your hair down!',
    username: 'tableSpoonSurprise',
    created_at: 1557870114286,
    location_lat: 53.959198,
    location_long: -1.081358,
    likes: 65,
    belongs_to_tag_text: ['#kidsExperience', '#unusualEntertainment', '#dance', '#music', , ]
  }, {
    ...
    likes: 76,
    belongs_to_tag_text: ['#natureIsBeautiful', '#photography', '#outdoorExperience', ]
  }, {

    title: 'Free outdoor cooking.',
    body: 'York council have put permanent fire pits in towards the edge of the park. Anyone can use them and we had a great night around the camp fire! You have to bring your own fuel and lighter fluid.',
...

  {
    ...
    likes: 657,
    belongs_to_tag_text: ['#YOLO', '#outdoorExperience', '#unusualEntertainment', ]
  }, {
    ...
    location_long: 2.351580,
    likes: 45,
    belongs_to_tag_text: ['#authenticExperience', '#photography', '#ART', '#streetPerformers', '#music', ]
  }, {
