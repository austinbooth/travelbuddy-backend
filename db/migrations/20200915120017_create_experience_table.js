exports.up = function (knex) {
  return knex.schema.createTable("experiences", (experiencesTable) => {
    ...
    experiencesTable.string("username").references("users.username").notNullable();
    ...
    experiencesTable.string("belongs_to_tag_text").references("tags.tag_text").notNullable();
  })
